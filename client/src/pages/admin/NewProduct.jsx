...
const NewProduct = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get("https://kathy-wool-ecommerce-mqxh.onrender.com/categories");
    ...
    try {
      ...
      if (response.ok) {
        ...
        try {
          ...
          await axios.post("https://kathy-wool-ecommerce-mqxh.onrender.com/products", newProductForDB);
        } catch (error) {
